...
translatef("若有更新可点击上方 【手动更新】 后请耐心等待直至路由器重启.") .. "<br><br>当前固件版本: " .. current_version .. "<br>云端固件版本: " .. cloud_version.. "<br><br>设备名称: " .. cpu_info .. "<br>内核版本: " .. kernel_luci .. "<br>固件类型: " .. firmware_type)
